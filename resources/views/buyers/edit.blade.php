  ...
  <div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('buyers.update', $buyer->id) }}" method="POST" class="space-y-6">
          @csrf
          @method('PUT')
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input type="text" name="name" id="name" value="{{ $buyer->name }}" class="mt-1 block w-full p-4 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm
            ...
            <div>
              ...
              <input type="email" name="email" id="email" value="{{ $buyer->email }}" class="mt-1 block w-full p-4 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm
            ...
            <div class="md:col-span-2">
              ...
              <div class="mt-1 relative rounded-md shadow-sm">
                ...
                <input type="tel" name="phone" id="phone" value="{{ $buyer->phone }}" class="block w-full p-4 rounded-md border-gray-300 pl-12 focus:border-blue-500 focus:ring-blue-500 sm:text-sm
